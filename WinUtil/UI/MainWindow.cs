  ...
  public partial class MainWindow : Form
  {
    ...
    private void CheckSettings()
    {
      ...
      if (!ffmpegFound)
      {
        ...
        mainTabControl.TabPages.Remove(tabPageConvertToMp3);
      }
      else
      {
        ...
        if (!mainTabControl.TabPages.Contains(tabPageConvertToMp3))
          mainTabControl.TabPages.Add(tabPageConvertToMp3);
      }
